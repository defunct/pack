...
public class MoveRecorder
{
     ...
     */
    MoveRecorder(Bouquet bouquet, Map<Long, Long> moves)
    {
    ...
    /**
     * Move the all the blocks from the given <code>source</code> page to the given
     * <code>destination</code> page.
     * <p>
     ...
     * 
     * @param source The page position of the source page.
     * @param destination The page position of the destination page.
     */
